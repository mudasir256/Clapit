    ...
    return (
        <div>
            <div className={styles.homeheading} style={{ backgroundColor: currentTheme.secondary }}>
                ...
                <Link href="#work"><h1 className={styles.cta1} style={{ backgroundColor: currentTheme.accent, color: currentTheme.contrastText, boxShadow: currentTheme.boxShadow }}>{ctaTexts.landingCTA}</h1></Link>
            </div>
            <div className={styles.homeWorkSection} id="work">
                ...
                <div style={{ textAlign: 'center', paddingBottom: '2rem' }}><Link href="/work"><h1 className={styles.cta3} style={{ backgroundColor: currentTheme.accent, color: currentTheme.contrastText }}>{ctaTexts.workCTA} <span>&gt;</span></h1></Link></div>
            </div>
