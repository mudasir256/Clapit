...
const Skills = ({ currentTheme }) => {
    return (
        <>
            ...
            <div style={{ textAlign: 'center', padding: '1rem 0' }}><Link href="/contact"><h1 className={styles.cta3} style={{ background: 'transparent', border: `2px solid ${currentTheme.accent}` }}>{ctaTexts.capabCTA} <span>&gt;</span></h1></Link></div>
        </>
    )
}
